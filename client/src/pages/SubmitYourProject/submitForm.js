...
import { FormContainer, Card, ImageContainer, Description, Submission, InputContainer, Input, Upload, TextArea, ErrorText } from './style';
...
function SubmitForm({ user, onSubmit }) {
    ...
    function handleChange(e) {
        const values = e.target.value.length === 0 ? e.target.placeholder : e.target.value;
        setValue({
            ...value,
        ...
        <FormContainer>
            <Card>
                ...
                <Description>
                    ...
                    <Button loading={false} bgColor='#ED2C49' margin='20px 0 0 0'>Visit the repository</Button>
                </Description>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Submission>
                    ...
                    <InputContainer>
                        <label>Upload</label>
                        <Upload type='file' onChange={handleImage} placeholder='Title of the Project' />

                    </InputContainer>

                    <InputContainer>
                        <label>Title of the Project</label>
                        <Input name='title' maxLength='15' onChange={handleChange} placeholder='Title of the Project' ref={register({
                    ...
                    <InputContainer>
                        ...
                        <Input name='repoLink' onChange={handleChange} placeholder='Link to the repository' ref={register({
                    ...
                    <InputContainer>
                        ...
                        <Input name='siteLink' onChange={handleChange} placeholder='Link to the live site' ref={register({
                    ...
                    <InputContainer>
                        ...
                        <TextArea name='description' onChange={handleChange} placeholder='Used netlify for hosting in the live server.' ref={register({
